...
import { CONFIG_PATH_CLAWDBOT, DEFAULT_GATEWAY_PORT, readConfigFileSnapshot, resolveGatewayPort, writeConfigFile, } from "../config/config.js";
...
export async function runOnboardingWizard(opts, runtime = defaultRuntime, prompter) {
    ...
    const explicitFlow = explicitFlowRaw === "quickstart" || explicitFlowRaw === "advanced"
        ? explicitFlowRaw
        : undefined;
    ...
    if (opts.mode === "remote" && flow === "quickstart") {
        await prompter.note("QuickStart only supports local gateways. Switching to Advanced mode.", "QuickStart");
        flow = "advanced";
    }
