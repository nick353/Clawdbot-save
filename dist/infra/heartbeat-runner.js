...
import { DEFAULT_HEARTBEAT_ACK_MAX_CHARS, DEFAULT_HEARTBEAT_EVERY, resolveHeartbeatPrompt as resolveHeartbeatPromptText, stripHeartbeatToken, } from "../auto-reply/heartbeat.js";
...
export async function runHeartbeatOnce(opts) {
    ...
    try {
        ...
        const normalized = normalizeHeartbeatReply(replyPayload, resolveEffectiveMessagesConfig(cfg, agentId).responsePrefix, ackMaxChars);
