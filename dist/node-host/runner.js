...
import { addAllowlistEntry, analyzeArgvCommand, analyzeShellCommand, evaluateExecAllowlist, requiresExecApproval, normalizeExecApprovals, recordAllowlistUse, resolveExecApprovals, resolveSafeBins, ensureExecApprovals, readExecApprovalsSnapshot, resolveExecApprovalsSocketPath, saveExecApprovals, } from "../infra/exec-approvals.js";
...
async function handleInvoke(frame, client, skillBins) {
    ...
    const allowlistSatisfied = security === "allowlist" && analysis.ok ? allowlistEval.allowlistSatisfied : false;
    ...
    if (allowlistMatches.length > 0) {
        ...
        for (const match of allowlistMatches) {
            ...
            recordAllowlistUse(approvals.file, agentId, match, cmdText, analysis.segments[0]?.resolution?.resolvedPath);
        }
    }
