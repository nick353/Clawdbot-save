...
export async function startGatewayServer(port = 18789, opts = {}) {
    ...
    const { canvasHost, httpServer, wss, clients, broadcast, agentRunSeq, dedupe, chatRunState, chatRunBuffers, chatDeltaSentAt, addChatRun, removeChatRun, chatAbortControllers, } = await createGatewayRuntimeState({
        cfg: cfgAtStart,
        bindHost,
        port,
        controlUiEnabled,
