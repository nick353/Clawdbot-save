...
export async function tryHandleDiscordMessageActionGuildAdmin(params) {
    ...
    if (action === "emoji-upload") {
        ...
        return await handleDiscordAction({ action: "emojiUpload", guildId, name, mediaUrl, roleIds }, cfg);
    }
    if (action === "sticker-upload") {
        ...
        return await handleDiscordAction({ action: "stickerUpload", guildId, name, description, tags, mediaUrl }, cfg);
    }
