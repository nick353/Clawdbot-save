...
import { markAuthProfileFailure, markAuthProfileGood, markAuthProfileUsed, } from "../auth-profiles.js";
        ...
        try {
            while (true) {
                ...
                if (promptError && !aborted) {
                    ...
                    const promptFallbackConfigured = (params.config?.agents?.defaults?.model?.fallbacks?.length ?? 0) > 0;
