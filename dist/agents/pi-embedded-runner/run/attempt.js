...
export async function runEmbeddedAttempt(params) {
    ...
    try {
        ...
        const reactionGuidance = runtimeChannel === "telegram" && params.config
            ? (() => {
        ...
        try {
            ...
            try {
                ...
                if (leafEntry?.type === "message" && leafEntry.message.role === "user") {
                    ...
                    const repairedCtx = sanitizeToolUseResultPairing(sanitizeErrorAssistantPairs(sessionContext.messages));
