 ...
 */
export function sanitizeToolCallId(id, mode = "standard") {
...
export function isValidCloudCodeAssistToolId(id, mode = "standard") {
    if (!id || typeof id !== "string")
        return false;
    if (mode === "strict") {
 ...
 */
export function sanitizeToolCallIdsForCloudCodeAssist(messages, mode = "standard") {
