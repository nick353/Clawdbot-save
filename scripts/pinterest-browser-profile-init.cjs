...
const PROFILE_DIR = '/root/clawd/browser-profiles/pinterest';
...
async function main() {
  ...
  console.log('📌 Pinterest ブラウザプロファイル初期化');
  console.log('='.repeat(50));
  console.log('');
  ...
  // Pinterestにアクセス
  console.log('');
  console.log('🌐 Pinterest にアクセスしています...');
  ...
  // スクリーンショット
  await page.screenshot({ path: '/tmp/pinterest-profile-init.png', fullPage: false });
  console.log('📸 スクリーンショット: /tmp/pinterest-profile-init.png');
  ...
  console.log('node post-to-pinterest-v2-anti-ban.cjs "テキスト" 画像パス');
  console.log('');
}
