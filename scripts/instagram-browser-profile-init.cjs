...
const COOKIE_PATH = '/root/clawd/skills/sns-multi-poster/cookies/instagram.json';
...
async function main() {
  ...
  console.log('📷 Instagram ブラウザプロファイル初期化');
  console.log('='.repeat(50));
  console.log('');
  ...
  // スクリーンショット
  await page.screenshot({ path: '/tmp/instagram-profile-init.png', fullPage: false });
  console.log('📸 スクリーンショット: /tmp/instagram-profile-init.png');
  ...
  console.log('node post-to-instagram-playwright.cjs 画像パス "キャプション"');
  console.log('');
}
